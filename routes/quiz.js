...
let qid = '';
let qd = ''; //maybe call it currentQuesitionID
...
.then((qqq) => {
qid = qqq;
return qid; //global quiz id varirable created
})
.then((quiz) => {
...
VALUES ($1, $2)
RETURNING id;
`, [req.body.q1, qid]) // Question 1 created
.then((question) => {
qd = question.rows[0].id;
console.log("QUESTIONID", qd)
db.query(`
INSERT INTO answers (correct_answer, incorrect_answers, question_id)
VALUES ($1, $2, $3)
RETURNING *;
`, [req.body.q1a1, [req.body.q1a2, req.body.q1a3, req.body.q1a4], qd]) // Q1 Answer created
.then(() => {
console.log("QUIZID22222", qid)
db.query(`
INSERT INTO questions (question, quiz_id)
VALUES ($1, $2)
RETURNING id;
`, [req.body.q2, qid]) // Question 2 created
.then((question2) => {
qd = question2.rows[0].id
return qd; //question id from last question created (Question 2)
})
.then(() => {
console.log("QUESTIONID2222", qd)
db.query(`
INSERT INTO answers (correct_answer, incorrect_answers, question_id)
VALUES ($1, $2, $3)
RETURNING *;
`, [req.body.q2a1, [req.body.q2a2, req.body.q2a3, req.body.q2a4], qd]) // Q2 Answer created
.then(() => {
console.log("QUIZID3333", qid)
db.query(`
INSERT INTO questions (question, quiz_id)
VALUES ($1, $2)
RETURNING id;
`, [req.body.q3, qid]) // Question 3 created
.then((question3) => {
qd = question3.rows[0].id
return qd; //question id from last question created (Question 3)
})
.then(() => {
console.log("QUESTIONID33333", qd)
db.query(`
INSERT INTO answers (correct_answer, incorrect_answers, question_id)
VALUES ($1, $2, $3)
RETURNING *;
`, [req.body.q3a1, [req.body.q3a2, req.body.q3a3, req.body.q3a4], qd]) // Q3 Answer created
.then(() => {
console.log("QUIZID44444", qid)
db.query(`
INSERT INTO questions (question, quiz_id)
VALUES ($1, $2)
RETURNING id;
`, [req.body.q4, qid]) // Question 4 created
.then((question4) => {
qd = question4.rows[0].id
return qd; //question id from last question created (Question 4)
})
.then(() => {
console.log("QUESTIONID33333", qd)
db.query(`
...
VALUES ($1, $2, $3)
RETURNING *;
`, [req.body.q4a1, [req.body.q4a2, req.body.q4a3, req.body.q4a4], qd]) // Q4 Answer created
.then(() => {
console.log("QUIZID5555", qid)
db.query(`
INSERT INTO questions (question, quiz_id)
VALUES ($1, $2)
RETURNING id;
`, [req.body.q5, qid]) // Question 5 created
.then((question5) => {
qd = question5.rows[0].id
return qd; //question id from last question created (Question 5)
})
.then(() => {
console.log("QUESTIONID33333", qd)
db.query(`
...
VALUES ($1, $2, $3)
RETURNING *;
`, [req.body.q5a1, [req.body.q5a2, req.body.q5a3, req.body.q5a4], qd]) // Q5 Answer created
.then(() => {
